      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              href="/stott-oss"
              className="inline-flex items-center px-6 py-2 bg-white text-accent font-heading font-medium text-sm rounded-full transition-all duration-200 cursor-pointer btn-magnetic border-2 border-accent/25 hover:border-accent"
            >
              Støtt oss
            </Link>
          </div>
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <div className="md:hidden pb-4 pt-2 border-t border-border/20 px-4 bg-white/95 backdrop-blur-md rounded-b-2xl">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-center border-t border-border/10 pt-4 mt-2">
                <Link
                  href="/stott-oss"
                  className="w-full text-center px-5 py-3 bg-white text-accent font-heading font-medium text-sm rounded-full transition-all duration-200 cursor-pointer btn-magnetic border-2 border-accent/25 hover:border-accent"
                >
                  Støtt oss
                </Link>
              </div>
