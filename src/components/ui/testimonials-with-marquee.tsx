    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 text-center sm:gap-16">
        <div className="flex flex-col items-center gap-4 px-4 sm:gap-8">
          <h2 className="max-w-[720px] font-heading text-lg sm:text-xl lg:text-2xl font-bold leading-tight text-text">
            {title}
          </h2>
          <p className="text-sm sm:text-base max-w-2xl leading-relaxed text-text-muted">
            {description}
          </p>
        </div>
