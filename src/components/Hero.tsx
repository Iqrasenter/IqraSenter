    ...
    >
      ...
      <div className="flex flex-col justify-center md:w-[55%] lg:w-[55%] max-w-2xl">
        ...
        <div className="hero-element flex flex-nowrap gap-2 md:gap-4 mt-6 md:mt-10">
          <Link
            href="/bli-medlem"
            className="group inline-flex items-center gap-1.5 md:gap-2 px-5 md:px-7 py-3 md:py-3.5 bg-primary hover:bg-primary-dark text-white font-heading font-semibold rounded-full transition-all duration-300 shadow-md hover:shadow-lg btn-magnetic text-sm md:text-base whitespace-nowrap"
          >
          ...
          <Link
            href="/kontakt"
            className="inline-flex items-center gap-1.5 md:gap-2 px-5 md:px-7 py-3 md:py-3.5 border-2 border-accent/25 hover:border-accent text-accent font-heading font-medium rounded-full transition-all duration-300 btn-magnetic text-sm md:text-base whitespace-nowrap"
          >
            Kontakt oss
          </Link>
        </div>
